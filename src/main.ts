...
app.innerHTML = `
  <main class="shell" aria-labelledby="page-title">
    <header class="hero"><p class="eyebrow">Deterministic ecosystem laboratory</p><h1 id="page-title">Evolution</h1><p class="summary">A reproducible living sandbox. Its first bounded world now renews seeded food resources on every fixed simulation tick.</p></header>
    <section class="panel" aria-labelledby="clock-title">
      ...
      <div class="metrics" aria-live="polite"><div><small>Simulated time</small><strong id="elapsed">0.00 s</strong></div><div><small>Food units</small><strong id="food">12,000</strong></div><div><small>Occupied cells</small><strong id="food-cells">0</strong></div><div><small>Seed</small><strong id="seed-display">42</strong></div></div>
    ...
    </section><footer><span>Milestone 1</span><span>Bounded renewable world</span></footer>
  </main>`;
